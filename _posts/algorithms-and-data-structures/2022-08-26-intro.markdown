...
Big O notation uses algebraic terms to describe the *complexity of our code*. It describes an asymptotic **upper bound** i.e., worst case operation or scenario.
